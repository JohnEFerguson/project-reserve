...
db.patientReserveCategory = require('../models/PatientReserveCategory.js')(sequelize)
...
db.categoryCriteriaPatientValue = require('../models/CategoryCriteriaPatientValue.js')(sequelize)
...
db.numericCriteriaPatientValue = require('../models/NumericCriteriaPatientValue.js')(sequelize)
...
db.reserveCategory.belongsToMany(db.patient, { through: db.patientReserveCategory })
db.patient.belongsToMany(db.numericCriteriaBucket, { through: db.numericCriteriaPatientValue})
